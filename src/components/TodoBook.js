        ...
        <>
            ...
            >
                ...
                <Modal title="Caracteristicas" visible={visible} onOk={handleOk} onCancel={handleCancel}>
                    ...
                    <p>
                        <strong>Parte de adelante del libro</strong>
                        <img alt="example" src={Databook.cover_page}/>
                    </p>
                    <p>
                        <strong>Parte de atras del libro</strong>
                        <img alt="example" src={Databook.back_cover}/>
                    </p>
                </Modal>
            </Card>
        </>
